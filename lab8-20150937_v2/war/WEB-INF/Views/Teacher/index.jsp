	 ...
	 <h4><b>Registro de Datos de Profesores</b></h4>
		<div class="table-responsive  ">
			<table class="table table-hover table-condensed">
				...
				<% 
					List<Teacher> array = (List<Teacher>)request.getAttribute("array");
				
					if(array.size() > 0) {	
						for(Teacher prof:array){
				%>
				<tr>
					...
					<td class='btn btn-group'>
						<a href="/teacher/view?codigo=<%= prof.getCodigo() %>" class="btn btn-primary btn-sm">Modificar</a> 
						<a href="/teacher/delete?codigo=<%= prof.getCodigo() %>" class="btn btn-danger btn-sm">Eliminar</a>
					</td>
				</tr>
				<% }
				} %>
			...
			<a href="/teacher" class="btn btn-success">ACTUALIZAR</a>
			<br>
			</div>
